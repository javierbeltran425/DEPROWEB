...
const HomeHeader = () => {
    ...
    return(
        <>
        <nav className="flex flex-col lg:flex-row lg:flex-wrap w-full lg:justify-between bg-gray-400 md:bg-transparent z-20">
            ...
            <AboutDropdownDiv useHeight={ aboutDropdown.show ? "300px" : "0" } className={" w-full h-auto flex justify-center transition-all transition-4000 ease-in-out"}>
                ...
                <div className="flex flex-row justify-between items-center">
                    ...
                    <img onClick={homeClick} src={logo2} className="h-14 md:w-auto md:h-20 ml-9  lg:display cursor-pointer"/>
                </div>
